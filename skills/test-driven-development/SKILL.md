...
**MANDATORY. Never skip.** Run the test via `bash`:
...
When adding mocks or test utilities, consult the **Testing Anti-Patterns** reference (auto-included below) to avoid:
